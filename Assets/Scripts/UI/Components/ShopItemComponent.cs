...
namespace UIToolkitDemo
{
    ...
    public class ShopItemComponent
    {
        ...
        const string k_ButtonDefaultClass = "shop-item__button";
        const string k_ButtonOwnedClass = "shop-item__owned-button";
        ...
        public void SetGameData(TemplateContainer shopItemElement)
        {
            ...
            // content value
            m_ContentCurrency.style.backgroundImage = new StyleBackground();
            m_ContentValue.text = "";
        ...
        {
            string currencyPostfix = " eth";

            if (m_ShopItemData.cost != 0)
            {
                m_Cost.text = m_ShopItemData.cost.ToString(CultureInfo.InvariantCulture) + currencyPostfix;
                Sprite currencySprite = m_GameIconsData.GetCurrencyIcon(CurrencyType.ETH);
                ...
                m_CostIconGroup.style.display = (m_ShopItemData.CostInCurrencyType == CurrencyType.ETH) ? DisplayStyle.None : DisplayStyle.Flex;
                m_DiscountIconGroup.style.display = (m_ShopItemData.CostInCurrencyType == CurrencyType.ETH) ? DisplayStyle.None : DisplayStyle.Flex;
            ...
            m_DiscountCost.text = (((100 - m_ShopItemData.discount) / 100f) * m_ShopItemData.cost).ToString(CultureInfo.InvariantCulture);
        }
        ...
        public void MarkAsOwned()
        {
            ...
            m_BuyButton.RemoveFromClassList(k_ButtonDefaultClass);
            m_BuyButton.AddToClassList(k_ButtonOwnedClass);
