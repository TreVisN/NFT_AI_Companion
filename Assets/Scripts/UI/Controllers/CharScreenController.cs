...
namespace UIToolkitDemo
{
    ...
    public class CharScreenController : MonoBehaviour
    {
        ...
        [Tooltip("Free characters to choose from.")]
        [SerializeField] List<CharacterData> m_Characters;
        
        [Tooltip("Locked characters.")]
        [SerializeField] List<CharacterData> m_LockedCharacters;
        ...
        void LookForNftCharacters()
        {
            ...
            foreach (var character in m_LockedCharacters.Where(character => character.CharacterBaseData.isNft))
            {
                if (nftManager.GetIsItemOwned(character.CharacterBaseData.nftItemId))
                {
                ...
                {
                    if (!nftManager.GetIsItemPreOwned(character.CharacterBaseData.nftItemId))
                        continue;
