...
namespace UIToolkitDemo
{
    public class CharScreen : MenuScreen
    {
        ...
        const string k_GearItemNftIcon = "gear-item__nft-icon";
        ...
        void OnGearSlotUpdated(EquipmentSO gearData, int slotToUpdate)
        {
            ...
            if (gearData == null)
            {
                if (gearElement != null)
                {
                    ...
                    activeSlot.Q(k_GearItemNftIcon).style.display = DisplayStyle.None;
                }
            ...
            else
            {
                if (gearElement != null)
                {
                    ...
                    if (gearData.isNft)
                        activeSlot.Q(k_GearItemNftIcon).style.display = DisplayStyle.Flex;
                }
