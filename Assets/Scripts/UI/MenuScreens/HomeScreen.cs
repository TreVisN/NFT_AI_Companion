...
namespace UIToolkitDemo
{
    public class HomeScreen : MenuScreen
    {
        ...
        protected override void SetVisualElements()
        {
            ...
            m_PlayLevelButton = m_Root.Q<Button>(k_PlayLevelButtonName);
        ...
        private void ShowLevelInfo(int levelNumber, string levelName, Sprite thumbnail, bool isLocked)
        {
            ...
            if (isLocked)
            {
                m_LevelLabel.style.fontSize = 30;
                m_PlayLevelButton.style.fontSize = 40;
                m_PlayLevelButton.text = "Learn More";
            }
        ...
        void OnShowLevelInfo(LevelSO levelData)
        {
            ...
            ShowLevelInfo(levelData.levelNumber, levelData.levelLabel, levelData.thumbnail, levelData.isLocked);
        }
    }
}